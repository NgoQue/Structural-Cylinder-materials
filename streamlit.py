...
if st.button("Run Spectral Absorption Prediction"):
    ...
    st.write('In the inner diameter range from 200 to 400 nanometers, the maximum absorption efficiency of :blue[**%s**] is **%.2f** %% at d= %d nm , h1 = %d nm' %(add_selectbox, H0*100, D0, D0+30))
